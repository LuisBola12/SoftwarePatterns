...
class Type {
 ...
 public:
  ...
  Activity* constructor_of_type(std::string name_of_type);
  int get_total_of_activities(std::string name_of_type);
  // This method prints the project's type
  void to_string_of_types();
  void set_number_of_times(type_of_project* project);
